...
%pseudo-overdomiance \citep{graham1997characterization, McMullen2009}, 
and epistasis \citep{minvielle1987dominance, schnell1992multiplicative}. 
Complementation of recessive deleterious alleles, however, remains the simplest genetic explanation \citep{Charlesworth2009}, and one that is supported by considerable empirical evidence \citep{xiao1995dominance, frascaroli2007classical}.
...
%Hybrid maize has formed the basis of modern maize agriculture since the early 20th century \citep{crow1998}. 
...
Broad sense heritability for these traits ranged from 0.65 for ASI to 0.95 for PHT. \jri{can we add these as a supp. table for all traits, or list them all here?}
...
In this study we have identified more than 500,000 conserved (GERP >0) sites in the genome segregating for putatively deleterious alleles in a panel of elite maize lines. 
...
Nonetheless, each inbred line carries a large number of deleterious variants, averaging $\sim 100,000$ per line. 
