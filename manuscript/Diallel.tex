...
The phenomenon of heterosis or hybrid vigor, refering to the superior performance of hybrids as compared to their parents, was intially documented by Darwin and recovered by Shull and East (Duvick 2001). This phenomenon has been observed for many species, from here to there (citation). Although it has been entensively studied, the mechianism controlling for heterosis remains unclear. Recently studies indicated that the complementation effect of the deleterious alleles may play an important role in determining this phenomenon. Deleterious alleles was arisen from new mutations during the evolutionary process. Because of the determintal or lethal of the large effect deleterious alleles, Natural selection tends to against. 
...
\textbf{Inbreeding depression and segregating deleterious variants}
\begin{itemize}
...
Residual heterozygosity in RILs correlates negatively with recomination (Gore et al. 2009 Science, McMullen et al. 2009 Science). Low recombination is effective over long time scales (Haddrill et al. 2007 Genome Biology). Deleterious alleles not correlated with recombination (G3) 

QTL for heterosis enriched in centromeric regions (Lariepe et al, 2012 Genetics).
...
Theoretical and empirical evidences suggrested that large proportion of new mutations are deleterious and large effect deleterious alleles were maintained in a low frequency in the population because they were selection against. 
