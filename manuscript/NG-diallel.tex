...
More than 86 million bp of the maize reference genome were annotated as conserved\citep{rodgers2015recombination}, with GERP scores $>0$.
Nonetheless, 506,898 (or 0.6\%) of these sites were found to segregate among the 12 inbred parents of our diallel (\textbf{Figure \ref{fig:gerpmaf}A} and \textbf{Supplementary Figure 1}).
On average, each inbred parent carried 215,809 putative deleterious variants, ranged from 186,708 of PHG35 to 227,681 of LH123HT. Mo17 carried 225,830 putative deleterious variants, ranking as the second most inbred. \yang{to do: no pairwise complementation} 
\yang{to do 2:, cm variation}
