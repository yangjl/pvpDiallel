...
To reproduce the figures, we should set `pvpDiallel` as you current path, i.e. `setwd("~/Documents/Github/pvpDiallel/")`.
...
plotH2(getpdf=F, outfile="graphs/Fig1a_v3.pdf",
...
plotloh(getpdf=F, outfile="graphs/Fig1a_v3.pdf",
...
plotReg(getpdf=F, outfile="graphs/Fig1c_v3.pdf",
...
plotbeans(getpdf=F, outfile="graphs/Fig1d.pdf",
