...
ht=4.5; wt=4.5 #figure height and weight
getpdf <- FALSE # get figures in seperated pdf [TRUE] or not [FALSE]
```

# Figure 1a

```{r, eval=TRUE, fig.width=ht, fig.height=wt}
plotH2 <- function(getpdf, outfile, ...){
...
plotH2(getpdf, outfile="graphs/Fig1a_v3.pdf",
       ylim=c(0, 1), col="antiquewhite3",  ylab="Heritability", 
          cex.axis=fs, cex.names=fs, cex.lab=fs, las=2)
```
...
plotloh(getpdf, outfile="graphs/Fig1b_v3.pdf",
...
plotReg(getpdf, outfile="graphs/Fig1c_v3.pdf",
...
plotbeans(getpdf, outfile="graphs/Fig1d_v3.pdf",
