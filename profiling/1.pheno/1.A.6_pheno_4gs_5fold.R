...
####
system("mkdir largedata/pheno/CV5fold/")
set.seed(12345)

trait5fold(times=10) # total file 7 traits x 5fold x 10 sample =350 x 2(test file and validation file)
