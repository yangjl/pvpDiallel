...
run_GenSel4(inputdf, inpdir="largedata/newGERPv2/allgeno_perse_a", cmdno=500,
...
run_GenSel4(inputdf=inputdf3, inpdir="largedata/newGERPv2/allgeno_perse_k5", cmdno=100,
