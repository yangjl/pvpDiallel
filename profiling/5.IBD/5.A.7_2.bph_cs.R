...
for(i in 1:10){
  setup_newbin_array(
    genobase= paste0("largedata/SNP/bph_b0_cs/gerpv2_b0_cs", i), jobid=21*(i-1)+1,
...
for(i in 1:10){
  setup_gensel_array(
    outdir="slurm-scripts/bph_cv_b0", jobbase="bph_gs_job", jobid=100*(i-1)+1,
    inpbase= paste0("slurm-scripts/bph_cv_b0/cs", i),
    genobase= paste0("largedata/SNP/bph_b0_cs/gerpv2_b0_cs", i))
...
for(i in 1:10){
  setup_gerpibd_array_7traits(
    outdir="slurm-scripts/bph_cv_b2", jobbase="gerpid_cs_job", jobid = 7*(i-1)+1,
    genobase= paste0("largedata/SNP/bph_b2_cs/gerpv2_b2_cs", i))
}
