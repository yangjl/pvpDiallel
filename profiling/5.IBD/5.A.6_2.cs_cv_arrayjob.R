...
for(i in 1:10){
  setup_newbin_array(
    genobase= paste0("largedata/SNP/geno_b0_cs/gerpv2_b0_cs", i), jobid=21*(i-1)+1,
...
for(i in 1:10){
  setup_gensel_array(
    outdir="slurm-scripts/cv_b0", jobbase="run_gs_job", jobid=100*(i-1)+1,
    inpbase= paste0("slurm-scripts/cv_b0/cs", i),
