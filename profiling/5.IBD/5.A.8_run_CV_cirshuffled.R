...
for(myi in 1:7){
  sh1 <- RunByTrait(i=myi)
  ### slurm input
  slurm4GenSelCV(
    shfile= paste0("slurm-scripts/cv", ti[myi], "_run2000.sh"), shcommand = sh1,
    sbathJ= paste0("cv_run2k_", ti[myi]),  
...
###>>> RUN: sbatch -p serial --ntasks=2 --mem 16000 slurm-scripts/cvtw_run2000.sh 
sbatch -p serial --ntasks=2 --mem 16000 slurm-scripts/cvpht_run2000.sh
sbatch -p serial --ntasks=2 --mem 16000 slurm-scripts/cvgy_run2000.sh
sbatch -p serial --ntasks=2 --mem 16000 slurm-scripts/cveht_run2000.sh
sbatch -p serial --ntasks=2 --mem 16000 slurm-scripts/cvdts_run2000.sh
sbatch -p serial --ntasks=2 --mem 16000 slurm-scripts/cvdtp_run2000.sh
